...
#SBATCH --job-name=myMakeFastq
#SBATCH --mem=10G
#SBATCH --mail-user=rory.malek@nih.gov
#SBATCH --mail-type=BEGIN,END
#SBATCH --cpus-per-task=16
#SBATCH --output=logs/mkfastq.txt
#SBATCH --error=logs/mkfastq.txt
...
run_name="/data/vrc_bsc/Rory/Covail/01_raw-data/231031_A01759_0037_BHMHVTDSX7"

current_projectPath="/data/vrc_bsc/Rory/Covail/"

current_ver="02_CellRanger"

sample_sheet="${current_projectPath}/${current_ver}/SampleSheet.csv"

output_path="${current_projectPath}/${current_ver}/raw_data"
