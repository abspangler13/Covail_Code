...
#remove cluster 5- this is junk (weird FCRL4 numbers, weird expression profile overall)
seuObj <- seuObj %>% filter(!seurat_clusters %in% c(10, 9))
...
pdf(file = here::here("04_Analysis","plots","05_clustering", "res_03","DimPlot_rna_UMAP_Positive_final_03res.pdf"))
...
pdf(file = here::here("04_Analysis","plots","05_clustering", "res_03","DimPlot_prot_UMAP_final_03res.pdf"))
ElbowPlot(seuObj)
...
seuObj <- FindClusters(seuObj, graph.name = "harmony.snn", algorithm = 3, resolution = 0.3, verbose = FALSE) #upped the resolution to see what happens
...
pdf(file = here::here("04_Analysis","plots","05_clustering", "res_03","DimPlot_UMAP_Multimodal_Final_03res.pdf"))
...
pdf(file = here::here("04_Analysis","plots","05_clustering","DimPlot_UMAP_clustering_final_03res.pdf"))
...
saveRDS(seuObj, file = here::here("04_Analysis","data_objects","05_clustering", "res_03","COVAIL_ReclusteredAzimuth_03res.rds"))

#let's look at some plots to see how things stack up
pdf(file = here::here("04_Analysis","plots","05_clustering", "res_03","DimPlot_UMAP_clustering_final_03res.pdf"))
DimPlot(seuObj, reduction = "harmony.wnn.umap", group.by = "harmony.snn_res.0.4", label = TRUE)
dev.off()

pdf(file = here::here("04_Analysis","plots","05_clustering", "res_03","DimPlot_UMAP_clustering_final_03res_probedata.pdf"))
DimPlot(seuObj, reduction = "harmony.wnn.umap", group.by = "adj.ProtoOmi", label = TRUE)
dev.off()

pdf(file = here::here("04_Analysis","plots","05_clustering", "res_03","DimPlot_UMAP_clustering_final_03res_plottedagainstsecondplot.pdf"))
...
pdf(file = here::here("04_Analysis","plots","05_clustering", "res_03","UMAP_clustering_final_overtime_03res.pdf"), height = 4, width = 12)
...
pdf(file = here::here("04_Analysis","plots","05_clustering", "res_03","FeaturePlot_UMAP_clustering_03resolution.pdf"), height = 6, width = 10)
...
pdf(file = here::here("04_Analysis","plots","05_clustering", "res_03","DimPlot_UMAP_clustering_probe_label_final_03res.pdf"))
...
pdf(file = here::here("04_Analysis","plots","05_clustering", "res_03","Protein_ridge_plots_final_03res.pdf"))
...
write.csv(markers, here::here("04_Analysis", "data_objects", "05_clustering", "res_03", "FinalDataset_DEAnalysis_03res.csv"))
