...
#read in the smartseq+msd dataset
...
#save
write.csv(wideData, here::here("04_Analysis", "data_objects", "figure_testing", "testing_ratpig_inclusion", "MergedCiteSeqAndSmartSeqSequences_rbdneg.csv"))
