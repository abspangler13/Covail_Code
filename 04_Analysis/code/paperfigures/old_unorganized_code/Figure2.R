...
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "Figure2h_FoldCross_ProtoBeta_COMBINEDMRNAPROT.png"),width = 1.35, height = 1.8, units = "in", device = "png", dpi = 900)
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "Figure2h_FoldCross_ProtoBeta_COMBINEDMRNAPROT.svg"),width = 1.35, height = 1.8, device = "pdf")
dev.off()
...
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "Figure2h_FoldPrototype_ProtoNotBeta_COMBINEDMRNAPROT.png"),width = 2.65, height = 1.8, units = "in", device = "png", dpi = 600)
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "Figure2h_FoldPrototype_ProtoNotBeta_COMBINEDMRNAPROT.svg"),width = 2.65, height = 1.8, device = "pdf")
dev.off()
...
ggplot(stats, aes(x = Timepoint, y=meanC, fill = Immunogen))+
  ...
  theme(plot.title = element_text(size = 8, hjust = 0.5),
        ...
        legend.position = "none",
        axis.line = element_line(size = 0.3))
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "Figure2h_FoldCross_ProtoOmicron_COMBINEDMRNAPROT.png"),width = 1.35, height = 1.8, units = "in", device = "png", dpi = 600)
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "Figure2h_FoldCross_ProtoOmicron_COMBINEDMRNAPROT.svg"),width = 1.35, height = 1.8, device = "pdf")
dev.off()
...
ggplot(stats, aes(x = Timepoint, y=meanP, fill = Immunogen))+
  ...
  theme(plot.title = element_text(size = 9, hjust = 0.5),
        ...
        legend.text = element_text(size = 8),
        legend.box.spacing = margin(0.5))
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "Figure2h_FoldPrototype_ProtoNotOmi_COMBINEDMRNAPROT.png"),width = 2.65, height = 1.8, units = "in", device = "png", dpi = 600)
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "Figure2h_FoldPrototype_ProtoNotOmi_COMBINEDMRNAPROT.svg"),width = 2.65, height = 1.8, device = "pdf")
dev.off()
...
stats <- flow %>% filter(Immunogen %in% c("Prototype", "Prototype/BA.1", "Omicron BA.1", "Beta/BA.1")) %>%
  ...
  filter(Timepoint == "15")
write.csv(stats, here::here("04_Analysis", "data_objects", "paperfigures", "Figure 2", "FoldChange_Day15_CrossReactiveProtoSpecific_BA1.csv"))
...
stats <- flow %>% filter(Immunogen %in% c("Prototype", "Prototype/Beta", "Beta"), Company != "Moderna") %>%
  ...
  select(Immunogen, `Subject ID`, Timepoint, FoldCross, FoldProt) %>%
  filter(Timepoint == "15")
write.csv(stats, here::here("04_Analysis", "data_objects", "paperfigures", "Figure 2", "FoldChange_Day15_CrossReactiveProtoSpecific_Beta.csv"))
#####
...
ggplot(stats) +
  ...
  facet_grid(cols = vars(Immunogen), labeller = label_wrap_gen(15))+
  ...
  theme(legend.key.size = unit(0.2, 'cm'),
        ...
        legend.box.spacing = margin(0.5))
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "Figure2_ProtoBetaCrossReactiveBarplot_COMBINEDMRNAPROT.png"),width = 1.93, height = 2, units = "in", device = "png", dpi = 900)
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "Figure2_ProtoBetaCrossReactiveBarplot_COMBINEDMRNAPROT.svg"),width = 1.93, height = 2)
dev.off()
...
ggplot(stats) +
  ...
  theme(legend.key.size = unit(0.2, 'cm'),
        ...
        legend.text = element_text(size = 7),
        legend.box.spacing = margin(0.5))
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "Figure2_ProtoOmiCrossReactiveBarplot_COMBINEDMRNAPROT.png"),width = 2.4, height = 2, units = "in", device = "png", dpi = 900)
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "Figure2_ProtoOmiCrossReactiveBarplot_COMBINEDMRNAPROT.svg"),width = 2.4, height = 2)
dev.off()
...
ggplot(stats[stats$Timepoint == "15",], aes(x= Immunogen, y = Fold))+
  ...
  theme(plot.title = element_text(size = 8, hjust= 0.5),
        ...
        legend.position = "none",
        axis.line = element_line(size = 0.3))
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "FoldChange_RatioCrossOmiToProtoSpecific.png"),width = 1.7, height = 2.8, dpi = 800, units = "in")
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "FoldChange_RatioCrossOmiToProtoSpecific.svg"),width = 1.7, height = 2.8)
dev.off()
...
ggplot(stats[stats$Timepoint == "15",], aes(x= Immunogen, y = Fold))+
  ...
  theme(plot.title = element_text(size = 8, hjust = 0.5),
        ...
        legend.position = "none",
        axis.line = element_line(size = 0.3))
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "FoldChange_RatioCrossBetaToProtoSpecific_AllVaxCombined.png"),width = 1.5, height = 2.8, units = "in", device = "png", dpi = 600)
ggsave(filename = here::here("04_Analysis", "plots", "paperfigures", "Figure 2", "FoldChange_RatioCrossBetaToProtoSpecific_AllVaxCombined.svg"),width = 1.5, height = 2.8)
dev.off()
...
write.csv(stats, here::here("04_Analysis", "data_objects", "paperfigures", "Figure 2", "BA1_RatioCrossReactive_to_Prototype.csv"))
...
write.csv(stats, here::here("04_Analysis", "data_objects", "paperfigures", "Figure 2", "Beta_RatioCrossReactive_to_Prototype.csv"))
