...
#filter to just infected individuals
flow <- flow %>% filter(`Subject ID` %in% flow$`Subject ID`[flow$infect_flag == "Y"])

#add a column that describes between which times someone is infected
