...
write_xlsx(statsba1, here::here("04_Analysis", "data_objects", "Figure S2", "BA1AntigenSpecificity_ByBooster.xlsx"))
...
statsbeta <- beta %>%
  ...
  pivot_longer(contains("Proto"), names_to = "AntigenSpecificity") %>%
  pivot_wider(names_from = Timepoint, values_from = value)
write_xlsx(statsba1, here::here("04_Analysis", "data_objects", "Figure S2", "BetaAntigenSpecificity_ByBooster.xlsx"))
######
