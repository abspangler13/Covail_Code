...
write_xlsx(finalFlow, here::here("01_raw-data", "FlowData", "FinalizedDatasets", "Unfiltered_COVAILFlowDataset_250318.xlsx"))
...
flow3  <- flow3 %>% filter(infect_baseline != "Y", infect_flag != "Y")
...
write_xlsx(finalFlow2, here::here("01_raw-data", "FlowData", "FinalizedDatasets", "Filtered_COVAILDataset_250318_CORRECTED.xlsx"))